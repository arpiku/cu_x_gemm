...
constexpr const char* const VARIANT_ID   = "r2z_128_optD";
constexpr const char* const VARIANT_DESC = "64x64_BK32_128t_db_async";
...
void launch_gemm_fp32_r2z_128_optD(
    const float* d_A,
    const float* d_B,
    float*       d_C,
    int M, int N, int K,
    ...
    cudaStream_t stream)
{
    using namespace r2z_128_optD_config;
...
const char* get_variant_id_fp32_r2z_128_optD()   { return VARIANT_ID; }
const char* get_variant_desc_fp32_r2z_128_optD() { return VARIANT_DESC; }

...
// r2z_256_opt1: Option 1 - 64x128 tiles, TM=8, TN=8, 128 threads
//
// TUNING: Wider tiles (BN=128) for better N-dimension parallelism
//         TM=8, TN=8 gives 128 threads = (64/8)*(128/8) = 8*16
...
namespace r2z_256_opt1_config {
    constexpr int BM = 64;
    constexpr int BN = 128;  // Wider tiles
    constexpr int BK = 16;
    constexpr int WM = 64;
    constexpr int WN = 64;
    constexpr int WNITER = 2;
    constexpr int TM = 8;
    constexpr int TN = 8;    // Larger TN for wider tiles
    constexpr int NUM_THREADS = 128;  // (64/8)*(128/8) = 8*16 = 128
}

constexpr const char* const VARIANT_ID   = "r2z_256_opt1";
constexpr const char* const VARIANT_DESC = "64x128_128t_db_async_opt1";
...
void launch_gemm_fp32_r2z_256_opt1(
    const float* d_A,
    const float* d_B,
    float*       d_C,
    int M, int N, int K,
    ...
    cudaStream_t stream)
{
    using namespace r2z_256_opt1_config;
...
const char* get_variant_id_fp32_r2z_256_opt1()   { return VARIANT_ID; }
const char* get_variant_desc_fp32_r2z_256_opt1() { return VARIANT_DESC; }

...
// r2z_128: Size-tuned r2z kernel for matrices 128-256
//
// TUNING: BK=32 (vs BK=16 in original) gives better arithmetic intensity
//         for small matrices with fewer K-iterations.
// Performance: ~74% at 128, ~70% at 256 (vs ~72%/~68% with BK=16)
//
// Key optimizations:
...
namespace r2z_128_config {
    constexpr int BM = 64;
    constexpr int BN = 64;
    constexpr int BK = 32;  // TUNED: Larger BK for better reuse at small sizes
    constexpr int WM = 32;
    constexpr int WN = 32;
...
constexpr const char* const VARIANT_ID   = "r2z_128";
constexpr const char* const VARIANT_DESC = "64x64_BK32_128t_db_async_tuned";
...
void launch_gemm_fp32_r2z_128(
    ...
    cudaStream_t stream)
{
    using namespace r2z_128_config;
...
const char* get_variant_id_fp32_r2z_128()   { return VARIANT_ID; }
const char* get_variant_desc_fp32_r2z_128() { return VARIANT_DESC; }

...
// r2z_256: Size-tuned r2z kernel for size 256
//
// TUNING: 256 threads (vs 128 in r2z_128) for better occupancy at size 256
//         TM=8, TN=2 gives 256 threads = (64/8)*(64/2) = 8*32
//         Each thread handles 8x2 output tile
// Performance target: >70% at 256
//
// Key optimizations:
...
constexpr const char* const VARIANT_ID   = "r2z_256";
constexpr const char* const VARIANT_DESC = "64x64_BK32_256t_db_async_tuned";
...
void launch_gemm_fp32_r2z_256(
    ...
    cudaStream_t stream)
{
    using namespace r2z_256_config;
...
const char* get_variant_id_fp32_r2z_256()   { return VARIANT_ID; }
const char* get_variant_desc_fp32_r2z_256() { return VARIANT_DESC; }

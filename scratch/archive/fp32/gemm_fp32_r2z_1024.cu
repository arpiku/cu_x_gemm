...
constexpr const char* const VARIANT_ID   = "r2z_1024";
...
void launch_gemm_fp32_r2z_1024(
    const float* d_A,
    const float* d_B,
    float*       d_C,
    int M, int N, int K,
    ...
    cudaStream_t stream)
{
    using namespace r2z_1024_config;
...
const char* get_variant_id_fp32_r2z_1024()   { return VARIANT_ID; }
const char* get_variant_desc_fp32_r2z_1024() { return VARIANT_DESC; }

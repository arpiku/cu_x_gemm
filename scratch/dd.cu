...
struct SmallTC1Config {
    ...
    static constexpr const char* ID = "tc1_small";
};
...
struct MediumTC1Config {
    ...
    static constexpr int NUM_THREADS = 128;
    static constexpr const char* ID = "tc1_medium";
};
...
struct LargeTC1Config {
    ...
    static constexpr const char* ID = "tc1_large";
};
    ...
    float alpha, float beta)
{
    ...
    // Double-buffered SMEM — row-major layout, same as tc0
...
constexpr const char* const TC1_VARIANT_DESC = "tf32_cpasync_doublebuf_ptx_mma";

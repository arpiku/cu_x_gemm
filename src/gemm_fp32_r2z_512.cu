...
constexpr const char* const VARIANT_ID   = "r2z_512";
...
void launch_gemm_fp32_r2z_512(
    ...
    cudaStream_t stream)
{
    using namespace r2z_512_config;
...
const char* get_variant_id_fp32_r2z_512()   { return VARIANT_ID; }
const char* get_variant_desc_fp32_r2z_512() { return VARIANT_DESC; }
